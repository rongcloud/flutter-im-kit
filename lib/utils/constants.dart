...
const Color textfieldBackgroundColor = Color(0xFFF5F6F9); // 输入框颜色
const Color textfieldFilledColor = Colors.white; // 输入框填充
const Color textfieldFilledSendingColor = Color(0xFFE0E2E3); // 输入框发送状态填充
const Color textfieldBorderColor = Color(0xFFE3E5E6); // 输入框边框颜色
const Color textfieldHintColor = Colors.grey; // 输入框边框颜色
const Color meBubbleColor = Color(0xFFCAEAFF); // 我的对话气泡颜色
const Color othersBubbleColor = Colors.white; // 其他人对话气泡颜色
const Color systemBubbleColor = Colors.grey; // 其他人对话气泡颜色
const Color fileBubbleColor = Colors.white; // 其他人对话气泡颜色
...
const double itemHorizontalPadding = 16;
const double itemVerticalPadding = 0;
const double avatarHeight = 52.0;
...
const double convoPopupFontSize = 14;

const double kPopupIconSize = 20.0;

const double convoPopupPaddingWidth = 7;
const double convoPopupPaddingHeight = 5;

const double slideItemSize = 76.0;
const double slideItemIconSize = 30.0;

const Color pageTipColor = Color(0x33FD4C4C);

const double convoTipFontSize = 12;

const double kConvoItemIconSize = 16;
const double kConvoItemIconPadding = 8;

const double kConvoItemEmptyIconSize = 48;
//chat page
const double unreadFontSize = 14;
const double unreadBubbleWidth = 42;

//bubble
const double kBubbleWidthRatio = 0.86;
...
const double kBubbleMultiSelectIconSize = 24;
...
const Color bubbleFileIconColorMe = Colors.white;
const Color bubbleFileIconColorOther = Color(0xFFC6CBD7);
const Color bubbleFileIconColorMeDark = Colors.white;
const Color bubbleFileIconColorOtherDark = Colors.white;

const double kBubbleSightIconSize = 44.0;

const double kBubbleVoiceIconSize = 24.0;
const double kBubbleVoiceIconPadding = 10.0;
...
const double kInputMultiSelectHeight = 61;
const double kInputMultiSelectButtonHeight = 22;
const double kInputMultiSelectButtonFontSize = 10;
